...
if ( ! empty( $wr_content ) ) {
	...
	$wr_output .= '<div class="quote-author mgt10 fwb" ' . WR_Nitro_Helper::schema_metadata( array( 'context' => 'author', 'echo' => false ) ) . '><span class="mgr10">-</span>' . esc_html( $wr_author ) . '</div>';
