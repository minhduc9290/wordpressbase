...
jQuery(document).ready(function ($) {
    ...
    jQuery(document).on('click touchstart', "a.snppopup-content, a[href^='#ninja-popup-']", function(e) {
        e.preventDefault();
...
function snp_open_select_link(el, blank) {
    ...
    if (jQuery(el).data('set-cookie') == 'yes') {
        snp_onconvert('redirect', false, false, true);
    }
...
function snp_open_link(el, blank) {
    ...
    if (jQuery(el).data('set-cookie') == 'yes') {
        snp_onconvert('optin', false, false, true);
    }
