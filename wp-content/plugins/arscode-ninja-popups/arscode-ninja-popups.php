    ...
    if (count($errors) > 0) {
        ...
        if ($ml_manager == 'directmail') {
            ...
            if (
                ...
                if (isset($POPUP_META['snp_ml_activecampaign_form'][0])) {
            ...
            try {
                ...
                $api->addContact($listId, $_POST['email'], $names['first'], $names['last'], $params);
            ...
            try {
                ...
                if ($api->addSubscriber($listId, $_POST['email'], $names['first'], $names['last'], $params)) {
                    $Done = 1;
                }
            } catch (Exception $e) {
            ...
            require_once SNP_DIR_PATH . '/include/mautic/Psr/Log/LoggerAwareInterface.php';
            require_once SNP_DIR_PATH . '/include/mautic/Psr/Log/LoggerInterface.php';
            require_once SNP_DIR_PATH . '/include/mautic/Psr/Log/LogLevel.php';

            require_once SNP_DIR_PATH . '/include/mautic/Psr/Log/AbstractLogger.php';
            require_once SNP_DIR_PATH . '/include/mautic/Psr/Log/NullLogger.php';
