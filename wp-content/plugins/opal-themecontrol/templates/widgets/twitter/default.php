...
<div class="widget-twitter block">
	<div class="block_content">
		<div id="opalthemer-twitter<?php echo esc_attr( $user ); ?>" class="opalthemer-twitter">
...
<script type="text/javascript">
	(function($) {
		...
		function hideTwitterBoxElements() {
		 setTimeout( function() {
		  if ( $('[id*=opalthemer-twitter<?php echo esc_js( $user ); ?>]').length ) {
		   $('#opalthemer-twitter<?php echo esc_js( $user ); ?> iframe').each( function(){
