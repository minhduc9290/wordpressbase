...
if ( $attachment_ids ) {
    $loop       = 0;
    $columns    = opal_themecontrol_get_options( 'woo-number-thumbnail-single', 3 );
    $classlayout = "";
    $layouts  = isset($_GET['layout']) ? $_GET['layout'] : opal_themecontrol_get_options('woocommerce-single-content-layout','1');
    ...
    ?>
    <div class="<?php echo esc_attr($classlayout); ?>" >
