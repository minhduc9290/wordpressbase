...
$productConfig = apply_filters('opalthemer_filter_product_config_zoom',array(     
...
<div class="images">
	...
	<?php
		if ( has_post_thumbnail() ) {
			...
			echo apply_filters( 'woocommerce_single_product_image_html', sprintf( '<img src="%s" alt="%s" />', wc_placeholder_img_src(), __( 'Placeholder', 'opalthemer-themer' ) ), $post->ID );
		}
	?>
