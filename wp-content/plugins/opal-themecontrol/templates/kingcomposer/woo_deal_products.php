 ...
 */
    ...
    $deals = array();
    $loop = opalthemer_themer_woocommerce_query('deals', $number_post);
    $_id = opalthemer_themer_makeid();
    $_count = 1;  
    switch ($columns) {
        case '5':
        case '4':
                                ...
                                <div class="product-block">
                                        ...
                                        <div class="button-action button-groups clearfix">
                                            ...
                                            <?php if( class_exists( 'YITH_Woocompare' ) ) { ?>
                                                ...
                                                <div class="yith-compare">
                                                    <a title="<?php esc_html_e( 'Add to compare', 'opal-themecontrol' ); ?>" href="<?php echo wp_nonce_url( add_query_arg( $url_args ), $action_add ); ?>" class="compare" data-product_id="<?php echo esc_attr($product->id); ?>">
                                                        <i class="fa fa-exchange"></i>
                                                    </a>
                                                </div>
                                            <?php } ?>
                                            <?php if(opalthemer_themer_fnc_theme_options('is-quickview', true)){ ?>
                                                <div class="quick-view hidden-xs">
                                                    <a title="<?php esc_html_e( 'Quick view', 'opal-themecontrol' ); ?>" href="#" class="quickview" data-productslug="<?php echo trim($product->post->post_name); ?>" data-toggle="modal" data-target="#opal-quickview-modal">
                                    ...
                                    <div class="caption media-body">
                                        <div class="deals-information">
                                            ...
                                            <div class="description"><?php echo opalthemer_themer_excerpt(30,'...');; ?></div>        
                                        </div>
                                        <div class="time">
                                            <?php if( $time_sale ) { ?>
                                        ...
                                        <div class="button-action button-groups clearfix">
                                            ...
                                            <?php if( class_exists( 'YITH_Woocompare' ) ) { ?>
                                                ...
                                                <div class="yith-compare">
                                                    <a title="<?php esc_html_e( 'Add to compare', 'opal-themecontrol' ); ?>" href="<?php echo wp_nonce_url( add_query_arg( $url_args ), $action_add ); ?>" class="compare" data-product_id="<?php echo esc_attr($product->id); ?>">
                                                        <i class="fa fa-exchange"></i>
                                                        <!-- <span><?php //esc_html_e('add to compare','opal-themecontrol'); ?></span> -->
                                                    </a>
                                                </div>
                                            <?php } ?>
                                            <?php if(opalthemer_themer_fnc_theme_options('is-quickview', true)){ ?>
                                                <div class="quick-view hidden-xs">
                                                    <a title="<?php esc_html_e( 'Quick view', 'opal-themecontrol' ); ?>" href="#" class="quickview" data-productslug="<?php echo trim($product->post->post_name); ?>" data-toggle="modal" data-target="#pbr-quickview-modal">
                                                       <i class="fa fa-eye"> </i><span><?php esc_html_e( 'Quick view', 'opal-themecontrol' ); ?></span>
                                                    </a>
                                                </div>
                                            <?php } ?>
                                        </div>
