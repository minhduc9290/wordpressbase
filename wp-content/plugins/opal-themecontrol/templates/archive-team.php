...
$column = opal_themecontrol_get_options('team_column') ? opal_themecontrol_get_options('team_column') : 4;
$colclass = floor(12/$column); 
$layous = opal_themecontrol_get_options('team_layout','grid');; 
						...
						<div class="team-archive">
							<div class="row">
								...
								<div class="col-lg-<?php echo esc_attr($colclass); ?> col-md-<?php echo esc_attr($colclass); ?> col-sm-<?php echo esc_attr($colclass); ?> <?php echo esc_attr($cls); ?>">
									<?php echo Opal_Themecontrol_Template_Loader::get_template_part( 'team/content-grid' ); ?>
								</div>
							<?php else: ?>
								<div class="col-md-12">
									<?php echo Opal_Themecontrol_Template_Loader::get_template_part( 'team/content-list' ); ?>
								</div>
							<?php endif; ?>
						<?php endwhile; ?>
					</div>
