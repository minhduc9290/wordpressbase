...
class Opal_Themecontrol_Socials_Siderbar_Widget extends Opal_Themecontrol_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'opalthemer_socials_siderbar_widget',
            // Widget name will appear in UI
            __('Opal Socials Siderbar', 'opal-themecontrol'),
            // Widget description
            array( 'description' => __( 'Share Socials Siderbar for website.', 'opal-themecontrol' ), )
        );
...
// Widget Backend
    ...
    ?>
    <div class="opalthemer_socials_siderbar">
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'list_service' )); ?>"><?php echo __( 'Share services social:', 'opal-themecontrol' ); ?></label>
            <br>
...
register_widget( 'Opal_Themecontrol_Socials_Siderbar_Widget' );