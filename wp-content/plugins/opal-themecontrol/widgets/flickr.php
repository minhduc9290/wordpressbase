...
class Opal_Themecontrol_Flickr_Widget extends Opal_Themecontrol_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'opalthemer_flickr_widget',
            // Widget name will appear in UI
            __('Opal Flickr', 'opal-themecontrol'),
            // Widget description
            array( 'description' => __( 'The most recent photos from flickr.', 'opal-themecontrol' ), )
        );
...
register_widget( 'Opal_Themecontrol_Flickr_Widget' );