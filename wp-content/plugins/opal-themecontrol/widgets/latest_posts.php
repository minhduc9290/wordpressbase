...
class Opal_Themecontrol_Latest_Posts extends Opal_Themecontrol_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'opalthemer_latest_posts',
            // Widget name will appear in UI
            __('Opal Latest Post Widget', 'opal-themecontrol'),
            // Widget description
            array( 'description' => __( 'Show list of latest posts', 'opal-themecontrol' ), )
        );
...
// Widget Backend
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = __( 'Latest news', 'opal-themecontrol' );
        }
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_post' )); ?>"><?php _e( 'Number Posts:', 'opal-themecontrol' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'number_rows' )); ?>"><?php _e( 'Number Rows:', 'opal-themecontrol' ); ?></label>
...
register_widget( 'Opal_Themecontrol_Latest_Posts' );