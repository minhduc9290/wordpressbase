...
class Opal_Themecontrol_Tweets_Widget extends Opal_Themecontrol_Widget{

    public function __construct() {
         parent::__construct(
            // Base ID of your widget
            'opalthemer_twitter_widget',
            // Widget name will appear in UI
            __('Opal Latest Twitter', 'opal-themecontrol'),
            // Widget description
            array( 'description' => __( 'Latest Twitter widget.', 'opal-themecontrol' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $defaults = array( 'title' => __('Latest tweets.', 'opal-themecontrol'),
                            'user' => __('Leotheme', 'opal-themecontrol'),
                ...
                $values = array(
                    1 => __('Yes', 'opal-themecontrol'),
                    0 => __('No', 'opal-themecontrol'),
                );              
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'user' )); ?>"><?php _e('Twitter Username:', 'opal-themecontrol'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'limit' )); ?>"><?php _e('Limit:', 'opal-themecontrol'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'twitter_id' )); ?>"><?php _e('Twitter Id:', 'opal-themecontrol'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'border_color' )); ?>"><?php _e('Border Color:', 'opal-themecontrol'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'link_color' )); ?>"><?php _e('Link Color:', 'opal-themecontrol'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'text_color' )); ?>"><?php _e('Text Color:', 'opal-themecontrol'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'name_color' )); ?>"><?php _e('Name Color:', 'opal-themecontrol'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'mail_color' )); ?>"><?php _e('Mail Color:', 'opal-themecontrol'); ?></label>
             <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'transparent' )); ?>"><?php _e('Show background', 'opal-themecontrol'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_replies' )); ?>"><?php _e('Show Replies', 'opal-themecontrol'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_header' )); ?>"><?php _e('Show Header', 'opal-themecontrol'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_footer' )); ?>"><?php _e('Show Footer', 'opal-themecontrol'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_border' )); ?>"><?php _e('Show Border', 'opal-themecontrol'); ?></label>
            <br>
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'show_scrollbar' )); ?>"><?php _e('Show Scrollbar', 'opal-themecontrol'); ?></label>
            <br>
...
register_widget( 'Opal_Themecontrol_Tweets_Widget' );
