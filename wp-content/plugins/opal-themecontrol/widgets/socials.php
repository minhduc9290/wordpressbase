...
class Opal_Themecontrol_Socials_Widget extends Opal_Themecontrol_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'opalthemer_socials_widget',
            // Widget name will appear in UI
            __('Opal Socials', 'opal-themecontrol'),
            // Widget description
            array( 'description' => __( 'Socials for website.', 'opal-themecontrol' ), )
        );
...
register_widget( 'Opal_Themecontrol_Socials_Widget' );