...
class Opal_Themecontrol_Facebook_Like_Box extends Opal_Themecontrol_Widget {
    public function __construct() {
        parent::__construct(
            // Base ID of your widget
            'opalthemer_facebook_like',
            // Widget name will appear in UI
            __('Opal Facebook Like Box', 'opal-themecontrol'),
            // Widget description
            array( 'description' => __( 'Adds support for Facebook Like Box. ', 'opal-themecontrol' ), )
        );
...
register_widget( 'Opal_Themecontrol_Facebook_Like_Box' );