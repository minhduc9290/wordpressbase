...
if(class_exists('Featured_Post_Widget')){
    ...
    class Opal_Themecontrol_Featured_Post_Widget extends Opal_Themecontrol_Widget {
        public function __construct() {
            parent::__construct(
                // Base ID of your widget
                'opalthemer_featured_post_widget',
                // Widget name will appear in UI
                __('Opal Featured Post Widget', 'opal-themecontrol')
            );
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('post_type')); ?>">
                    <?php echo __('Type:', 'opal-themecontrol' ); ?>
                </label>
                <br>
            ...
            <p>
                <label for="<?php echo esc_attr($this->get_field_id('num')); ?>"><?php __('Limit:', 'opal-themecontrol'); ?></label>
                <br>
    ...
    register_widget( 'Opal_Themecontrol_Featured_Post_Widget' );
}