...
class Opal_Themecontrol_Popupnewsletter_Widget extends Opal_Themecontrol_Widget{
    ...
    public function __construct() {
        parent::__construct(
            ...
            __('Opal Popup Newsletter Widget', 'opal-themecontrol'),
            // Widget description
            array( 'description' => __( 'Adds support Popup To Show Newsletter. ', 'opal-themecontrol' ), )
        );
    ...
    public function form( $instance ) {
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'title' )); ?>"><strong><?php _e('Title:', 'opal-themecontrol');?></strong></label>
            <input type="text" id="<?php echo esc_attr($this->get_field_id( 'title' )); ?>" name="<?php echo esc_attr($this->get_field_name( 'title' )); ?>" value="<?php echo esc_attr( $instance['title'] ) ; ?>" class="widefat" />
        </p>
                

        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php _e( 'Description:', 'opal-themecontrol' ); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'image' ) ); ?>"><?php _e( 'Image background:', 'opal-themecontrol' ); ?></label>
...
register_widget( 'Opal_Themecontrol_Popupnewsletter_Widget' );
