 ...
 */
if( !class_exists( "Opal_Themecontrol_Services_Widget" ) ){
    class Opal_Themecontrol_Services_Widget extends Opal_Themecontrol_Widget {
        public function __construct() {
            parent::__construct(
                // Base ID of your widget
                'opalthemer_services_widget',
                // Widget name will appear in UI
                __('Opal Services', 'opal-themecontrol'),
                // Widget description
                array( 'description' => __( 'Services', 'opal-themecontrol' ), )
            );
        ...
        ?>
        <div class="opalthemer_recentpost">
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php esc_html_e( 'Title:', 'opal-themecontrol' ); ?></label>
                <input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $instance['title'] ); ?>" />
            </p>

            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'helpline' ) ); ?>"><?php esc_html_e( 'Helpline:', 'opal-themecontrol' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'email' ) ); ?>"><?php esc_html_e( 'Email:', 'opal-themecontrol' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'workingdays' ) ); ?>"><?php esc_html_e( 'Working days:', 'opal-themecontrol' ); ?></label>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'donatelink' ) ); ?>"><?php esc_html_e( 'Button link:', 'opal-themecontrol' ); ?></label>
    ...
    <?php
        ...
        protected function default_instance_args( array $instance ) {
            return wp_parse_args( $instance, array(
                'title'   => esc_html__( 'Services', 'opal-themecontrol' ),
                'helpline'  => '',
                'email'  => '',
                'workingdays'  => '',
                'donatelink' => ''
    ...
    register_widget( 'Opal_Themecontrol_Services_Widget' );
}